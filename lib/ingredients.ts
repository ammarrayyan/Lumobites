...
export const ingredientDatabase: IngredientInfo[] = [
  ...
  // Grain fillers — common in lower-quality formulas, low nutritional value for carnivores
  { name: 'Corn', category: 'questionable', reason: 'High glycemic filler, common allergen', effects: 'Cheap carbohydrate with low bioavailability for pets.' },
  { name: 'Wheat', category: 'questionable', reason: 'Common allergen, gluten filler', effects: 'Can trigger sensitivities in many pets.' },
  { name: 'Rice', category: 'questionable', reason: 'Cheap starchy filler, high glycemic', effects: 'Low nutritional value for obligate carnivores.' },
  { name: 'White Rice', category: 'questionable', reason: 'High glycemic refined grain', effects: 'Spikes blood sugar, minimal nutrition.' },
  { name: 'Whole Grain Wheat', category: 'questionable', reason: 'Gluten-containing filler', effects: 'Common allergen, hard to digest for many pets.' },
  { name: 'Whole Grain Corn', category: 'questionable', reason: 'High glycemic filler', effects: 'Cheap energy source with poor pet bioavailability.' },
  { name: 'Ground Corn', category: 'questionable', reason: 'Cheap corn filler', effects: 'Low nutritional value, common allergen.' },
  { name: 'Corn Meal', category: 'questionable', reason: 'Cheap corn filler', effects: 'Processed corn product, low bioavailability.' },
  { name: 'Chicken By-Product Meal', category: 'questionable', reason: 'Vague unknown quality parts', effects: 'Non-human-grade poultry parts.' },
  { name: 'By-Product Meal', category: 'questionable', reason: 'Vague unknown quality', effects: 'May contain low-quality animal parts.' },
  ...
  { name: 'Brown Rice', category: 'neutral', reason: 'Digestible whole grain but starchy filler', effects: 'Steady energy source but not species-optimal.' },
  { name: 'Oatmeal', category: 'neutral', reason: 'Digestible grain, gentle on stomach', effects: 'Soothing on the gut.' },
  { name: 'Barley', category: 'neutral', reason: 'Digestible whole grain', effects: 'Low glycemic whole grain.' },
  { name: 'Millet', category: 'neutral', reason: 'Digestible grain gluten-free', effects: 'Ancient grain, easy to digest.' },

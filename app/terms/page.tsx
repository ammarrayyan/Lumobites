    ...
    return (
      <div className="min-h-screen bg-[#FDFAF7] font-sans text-[#555555]">
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 24px' }}>
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 700, marginTop: '32px', color: '#191919' }}>19. SMS and Phone Verification</h2>
          <p className="mt-2">By providing your phone number for verification purposes, you consent to receiving SMS messages from Lumo Bites via our SMS service provider (Twilio). Standard carrier message and data rates may apply. Phone numbers are used solely for identity verification and account security purposes and will not be used for marketing without your explicit consent.</p>

          <h2 style={{ fontSize: '20px', fontWeight: 700, marginTop: '32px', color: '#191919' }}>20. Third Party Services</h2>
          <p className="mt-2">Lumo Bites integrates with third-party services including but not limited to Stripe (payments), Twilio (SMS), Firebase (notifications), and Amazon (product recommendations). Your use of these services is subject to their respective terms of service and privacy policies. Lumo Bites is not responsible for the practices of these third-party providers.</p>
        </div>
      </div>
    );
  }

  ...
  return (
    <div className="min-h-screen bg-[#FDFAF7] font-sans text-[#555555]">
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 24px' }}>
        ...
        <p className="mt-2">Lumo Bites does not process, collect, hold, or escrow funds for pet sitting bookings, daycare services, or any other transactions between users. All payments, rates, fees, and tips are negotiated and handled directly and independently between the pet owner and the service provider (sitter, daycare, or clinic). Lumo Bites is not a party to any payment transaction between users and is not responsible for payment disputes, refunds, non-payment, or fee agreements.</p>

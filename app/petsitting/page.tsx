          ...
          <div className="max-w-2xl mx-auto bg-white rounded-3xl p-8 border border-[#E8DDD4] shadow-sm animate-fade-in">
            ...
            {sitterAuthMode === 'otp' && (
              <form onSubmit={handleSitterOtpSubmit} className="space-y-5 max-w-sm mx-auto animate-fade-in bg-white p-6 rounded-2xl border border-[#E8DDD4] shadow-sm">
                ...
                <div>
                  <input required type="text" maxLength={6} value={sitterAuthCode} onChange={e => setSitterAuthCode(e.target.value)} className="w-full bg-[#FAF6F4] border border-[#E8DDD4] rounded-xl px-4 py-4 text-center text-3xl tracking-[0.5em] font-black text-[#4A3E3D] focus:outline-none focus:border-[#8B5E3C] shadow-inner" placeholder="••••••" />
                </div>

    ...
    <div className="min-h-screen flex flex-col font-sans text-[#555555] bg-[#FDFAF7]">
      ...
      <section className="w-full bg-[#FDFAF7] px-6 pb-16">
        <div className="max-w-[1200px] mx-auto grid grid-cols-12 gap-6">
          ...
          {/* 1. Pet Sitting */}
          <div className="col-span-12 lg:col-span-5 bg-gradient-to-b from-[#FFFDFB] to-[#FFF9F6] border border-[#F5E1D5] rounded-3xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-xl hover:border-[#E8C0AB] transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div className="absolute top-0 right-0 bg-[#C2653C] text-white text-[10px] font-black uppercase tracking-[0.12em] px-3 py-1.5 rounded-bl-xl z-10 shadow-sm flex items-center gap-1">
              <Star className="w-3 h-3 text-white fill-white" /> Most Popular
            </div>
            <div className="flex items-center gap-3 relative z-10 mt-2">
              <div className="w-12 h-12 rounded-2xl bg-[#FFF0E8] flex items-center justify-center shadow-inner">
                <HomeIcon className="w-6 h-6 text-[#C2653C]" />
              </div>
              <h3 className="text-[#4F2D1C] font-extrabold text-xl">Pet Sitting</h3>
            </div>
            <p className="text-[#725E54] leading-relaxed relative flex-1 z-10 text-sm md:text-base">
              Find trusted local pet sitters in your neighborhood — verified profiles, real reviews, free to join.
            </p>
            <div className="mt-auto relative z-10">
              <Link href="/petsitting" className="block w-full py-3 rounded-xl bg-gradient-to-r from-[#C2653C] to-[#A8512C] text-white font-bold text-center hover:brightness-110 hover:shadow-md transition-all shadow-sm text-sm hover:scale-[1.01] active:scale-[0.99]" style={{ textDecoration: 'none' }}>
                Find Sitters &rarr;
              </Link>
            </div>
          </div>
          ...
          {/* 2. Lost Pets */}
          <div className="col-span-12 lg:col-span-4 bg-gradient-to-b from-[#FAFDFE] to-[#F3F8FC] border border-[#DCE8F5] rounded-3xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-xl hover:border-[#B7CFEA] transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div className="flex items-center gap-3 relative z-10">
              <div className="w-12 h-12 rounded-2xl bg-[#EAF4FF] flex items-center justify-center shadow-inner">
                <Footprints className="w-6 h-6 text-[#2D6A9F]" />
              </div>
              <h3 className="text-[#1F3E5C] font-extrabold text-xl">Lost Pets</h3>
            </div>
            <p className="text-[#56687C] leading-relaxed relative flex-1 z-10 text-sm md:text-base">
              Post a lost or found pet in seconds and reach your whole neighborhood instantly. Free, no account needed.
            </p>
            <div className="mt-auto relative z-10">
              <Link href="/lost-pets" className="block w-full py-3 rounded-xl bg-gradient-to-r from-[#2D6A9F] to-[#20527E] text-white font-bold text-center hover:brightness-110 hover:shadow-md transition-all shadow-sm text-sm hover:scale-[1.01] active:scale-[0.99]" style={{ textDecoration: 'none' }}>
                Post Lost Pet &rarr;
              </Link>
            </div>
          </div>
          ...
          {/* 3. Pet Food & Safety */}
          <div className="col-span-12 lg:col-span-3 bg-gradient-to-b from-[#FAFCF9] to-[#F4F8F3] border border-[#DCEAD9] rounded-3xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-xl hover:border-[#B9D9B5] transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div className="flex items-center gap-3 relative z-10">
              <div className="w-12 h-12 rounded-2xl bg-[#EAF3EA] flex items-center justify-center shadow-inner">
                <Utensils className="w-6 h-6 text-[#4E8D49]" />
              </div>
              <h3 className="text-[#244A21] font-extrabold text-xl">Pet Food & Safety</h3>
            </div>
            <p className="text-[#556953] leading-relaxed relative flex-1 z-10 text-sm md:text-base">
            ...
            <div className="mt-auto flex flex-col gap-2 relative z-10">
              <Link href="/chat" className="block w-full py-2.5 rounded-xl bg-gradient-to-r from-[#4E8D49] to-[#3D7239] text-white font-bold text-center hover:brightness-110 hover:shadow-md transition-all text-sm hover:scale-[1.01] active:scale-[0.99]" style={{ textDecoration: 'none' }}>
                Find Food &rarr;
              </Link>
              <Link href="/scan" className="block w-full py-2.5 rounded-xl border border-[#4E8D49]/30 text-[#4E8D49] font-bold text-center hover:bg-[#EAF3EA] hover:border-[#4E8D49]/60 transition-all text-sm" style={{ textDecoration: 'none' }}>
                Scan Label &rarr;
              </Link>
            </div>
          </div>

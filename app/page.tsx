    ...
    <div className="min-h-screen flex flex-col font-sans text-[#555555] bg-[#FDFAF7]">
      ...
      <section className="w-full flex flex-col items-center text-center px-6 bg-[#FDFAF7] pt-[48px] pb-16">
        <div className="max-w-[680px] mx-auto flex flex-col items-center">
          ...
          {/* Headline — exactly 2 lines, no orphans */}
          <h1
            className="font-[800] leading-[1.1] mb-6 tracking-[-0.02em] w-full"
      ...
      <section id="how" className="w-full bg-[#FDFAF7] px-6 py-[80px]">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-[#8B5E3C] text-[13px] font-bold tracking-[0.1em] uppercase mb-3">
              How it works
            </h3>
            <h2
              className="font-[800] text-[#191919] tracking-[-0.02em] leading-tight max-w-[600px] mx-auto"
          ...
          {/* 3-col grid forced via inline style to avoid Tailwind JIT purge */}
          <div
            style={{
              display: 'grid',
          ...
          >
            {/* Card 1 — DNA helix: unique, science-backed feel */}
            ...
            {/* Card 2 — Balance scales: smarter than a money bag */}
            <div className="bg-white rounded-[16px] p-8 shadow-[0_2px_16px_rgba(0,0,0,0.06)] flex flex-col items-center text-center hover:-translate-y-1 transition-transform">
              <span style={{ fontSize: '36px', lineHeight: 1, marginBottom: '20px', display: 'block' }}>💰</span>
            ...
            {/* Card 3 — Compass: navigating to the right store */}
            <div className="bg-white rounded-[16px] p-8 shadow-[0_2px_16px_rgba(0,0,0,0.06)] flex flex-col items-center text-center hover:-translate-y-1 transition-transform">
              <span style={{ fontSize: '36px', lineHeight: 1, marginBottom: '20px', display: 'block' }}>🏪</span>
      ...
      <section className="w-full px-6 py-[80px] text-center" style={{ backgroundColor: '#8B5E3C' }}>
        <div className="max-w-[700px] mx-auto">
          <h2
            className="font-[800] tracking-[-0.02em] leading-tight mb-4"
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '48px', maxWidth: '1200px', margin: '0 auto', marginBottom: '48px' }}>
          ...
          <div style={{ flex: '1 1 150px' }}>
            ...
            <ul className="space-y-3 text-sm" style={{ color: '#AAAAAA', listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li><a href="#" style={{ color: '#AAAAAA', textDecoration: 'none' }}>Compare Foods</a></li>
            </ul>
          </div>
          <div style={{ flex: '1 1 150px' }}>
            <h4 className="font-bold mb-4" style={{ color: '#FFFFFF' }}>Support</h4>
            <ul className="space-y-3 text-sm" style={{ color: '#AAAAAA', listStyle: 'none', padding: 0, margin: 0 }}>
              <li><a href="#" style={{ color: '#AAAAAA', textDecoration: 'none' }}>Help Center</a></li>
              <li><a href="#" style={{ color: '#AAAAAA', textDecoration: 'none' }}>Contact Us</a></li>
            </ul>
          </div>
          <div style={{ flex: '1 1 150px' }}>
            <h4 className="font-bold mb-4" style={{ color: '#FFFFFF' }}>Legal</h4>
            <ul className="space-y-3 text-sm" style={{ color: '#AAAAAA', listStyle: 'none', padding: 0, margin: 0 }}>
              <li><a href="#" style={{ color: '#AAAAAA', textDecoration: 'none' }}>Privacy Policy</a></li>
              <li><a href="#" style={{ color: '#AAAAAA', textDecoration: 'none' }}>Terms of Service</a></li>
            </ul>
          </div>
        </div>

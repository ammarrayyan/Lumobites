  ...
  try {
    ...
    const providersForClaude = [
      ...candidateSitters.map(s => ({
        ...
        rating: (s.review_count && s.review_count > 0) ? (s.avg_rating || null) : null,
        review_count: s.review_count || 0,
        is_new: !s.review_count || s.review_count === 0,
      ...
      .map((r: any) => {
        if (r.type === 'sitter') {
          ...
          return {
            ...
            rating: (sitter.review_count && sitter.review_count > 0) ? (sitter.avg_rating || null) : null,
            review_count: sitter.review_count || 0,
            is_new_sitter: !sitter.review_count || sitter.review_count === 0,

    ...
    <nav className="bg-white border-b border-[#EEEEEE] relative z-50">
      ...
      <div className="px-6 md:px-[48px] h-[72px] flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 ml-auto">
          <Link href="/scan" className="text-[#666666] font-medium text-sm hover:text-[#8B5E3C] transition-colors flex items-center nav-link">
          ...
          <Link href="/recalls" className="text-[#666666] font-medium text-sm hover:text-[#8B5E3C] transition-colors flex items-center nav-link">
          ...
          <Link href="/supplies" className="text-[#666666] font-medium text-sm hover:text-[#8B5E3C] transition-colors flex items-center nav-link">
          ...
          <Link href="/twin" className="text-[#8B5E3C] font-bold text-sm hover:underline transition-all flex items-center nav-link">

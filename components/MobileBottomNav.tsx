...
import { Home, PawPrint, MapPin, Search, Globe, Utensils, Scan, ShoppingBag } from 'lucide-react';
...
export default function MobileBottomNav() {
  ...
  const tabs = [
    ...
    { label: 'Pet Sitting', icon: PawPrint, href: '/petsitting', isActive: pathname === '/petsitting' },
          ...
          if (tab.isMenu) {
            return (
              <button
                ...
                className="flex flex-col items-center justify-center flex-1 h-full text-center gap-1 cursor-pointer bg-transparent border-none outline-none"
              >
                <Icon

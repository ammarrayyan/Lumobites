-- ============================================================
-- COMPREHENSIVE SUPABASE RLS HARDENING: ALL 40 TABLES IN SCHEMA
-- ============================================================

-- 1. Users, Accounts & Auth Credentials
...
-- 7. Pricing, Outbound & Admin Logging
ALTER TABLE IF EXISTS public.partner_pricing ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.partner_pricing_settings ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.pet_matches ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.twin_match_requests ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.notifications ENABLE ROW LEVEL SECURITY;

-- 8. Affiliates, Referrals & Moderation
...
-- Note: Service Role Key (`SUPABASE_SERVICE_ROLE_KEY`) automatically bypasses RLS on all tables.
